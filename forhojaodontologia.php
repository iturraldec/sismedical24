...
{
$reg = $tra->RegistrarHojaOdontologia();
exit;
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group has-feedback">
                    ...
                    <input type="hidden" name="codverifica" id="codverifica" value="<?php echo "7"; ?>"/>
...
<?php } ?>
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Gestión de Hoja Odontologíca</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <form class="form-material" novalidate method="post" action="#" name="savehojaodontologia" id="savehojaodontologia" enctype="multipart/form-data">
    ...
    <?php } ?>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> 2. Tratamiento</h5><hr>
