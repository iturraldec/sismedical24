...
document.title = '.:: Sistema de Gestión Clinico ::.';		
$(".current-year").text('2021 - ' + new Date().getFullYear() + ' CopyRight. Todos los Derechos Reservados. Ing. Christian Gonzales. G');
$(".current-detalle").text(' Desarrollo Web');
