                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Terapias por Pacientes</h5>
                                    </div>                 
                                </div>
                            </div>

    <div class="widget-content widget-content-area">                                
        <form class="form form-material" method="post" action="#" name="terapiasxpaciente" id="terapiasxpaciente">
        ...
        <button type="button" onClick="BuscarTerapiasxPaciente()" class="btn btn-primary"><i data-feather="search"></i> Realizar Búsqueda</button>
                                    </div>
            ...
            <div id="muestraterapiasxpaciente"></div>
