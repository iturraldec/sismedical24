        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    <input type="hidden" name="formulario" id="formulario" value="<?php echo "forhojac"; ?>"/>
                    ...
                    <!--<input type="hidden" name="codigo_procedimiento" id="codigo_procedimiento" <?php if (isset($reg[0]['codhoja'])) { ?> value="<?php echo encrypt($reg[0]['codprocedimiento']); ?>" <?php } ?>/>
                    <input type="hidden" name="nombre_procedimiento" id="nombre_procedimiento" <?php if (isset($reg[0]['codhoja'])) { ?> value="<?php echo encrypt($reg[0]['nombre_procedimiento']); ?>" <?php } ?>/>-->
...
<!--             <div class="col-md-6"> 
 ...
 -->
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Emitir Receta Médica</h5><hr>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i>Examenes Auxiliares</h5><hr>
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Nombre de Dx para Examenes Auxiliares: </label>
                    ...
                    <textarea class="form-control" name="observacionorden[]<?php echo $cont; ?>" id="observacionorden<?php echo $cont; ?>" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Examenes Auxiliares" title="Ingrese Observación de Examenes Auxiliares" rows="2" required="" aria-required="true"><?php echo $observacionorden; ?></textarea>
                </div>
            ...
            <?php endfor; 
                ...
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="ordenes[]" id="ordenes" onKeyUp="this.value=this.value.toUpperCase(); autocompletar(this.name);" placeholder="Ingrese Nombre de Dx para tu Busqueda" title="Ingrese Dx Examenes Auxiliares">
                    <textarea class="form-control" name="observacionorden[]" id="observacionorden" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Dx Examenes Auxiliares" title="Ingrese Observación de Dx Examenes Auxiliares" rows="2"></textarea>
                </div>
