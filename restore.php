                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Restauración de Base de Datos</h5>
                                    </div>                 
                                </div>
                            </div>
...
$bd= "softmedical"; //parametro obligatorio   
...
?> 
                    ...
                    <div class="form-group has-feedback">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="form-group has-feedback"> 
                                ...
                                </div><small class="alert-link"><p>Realice la búsqueda del Archivo para restaurar la Base de Datos</p></small>
                            </div>
                        </div>
                    </div> 
                </div>
        ...
        <button type="submit" name="upload" id="upload" class="btn btn-primary"><i data-feather="upload-cloud"></i> Restaurar</button>
