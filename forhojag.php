...
{
$reg = $tra->RegistrarHojasEvolutivas();
exit;
}
elseif(isset($_POST["proceso"]) and $_POST["proceso"]=="update")
{
$reg = $tra->ActualizarHojasEvolutivas();
exit;
} 
?>
<!DOCTYPE html>
...
<!--############################## MODAL BUSQUEDA DE CITAS EN HOJA EVOLUTIVA ######################################-->
<!-- Modal -->
...
<!--############################## MODAL BUSQUEDA DE CITAS EN HOJA EVOLUTIVA ######################################-->
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Gestión de Hoja Evolutiva</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <form class="form-material" novalidate method="post" action="#" name="updatehoja" id="updatehoja" data-id="<?php echo $reg[0]["codhoja"] ?>" enctype="multipart/form-data">
        
    <?php } else { ?>

    <form class="form-material" novalidate method="post" action="#" name="savehoja" id="savehoja" enctype="multipart/form-data">
    ...
    <?php } ?>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    <input type="hidden" name="formulario" id="formulario" value="<?php echo "forhojag"; ?>"/>
                    <input type="hidden" name="modulo" id="modulo" value="<?php echo "2"; ?>"/>
                    <input type="hidden" name="proceso" id="proceso" <?php if (isset($reg[0]['codhoja'])) { ?> value="update" <?php } else { ?>  value="save" <?php } ?>/>
                    <input type="hidden" name="idhoja" id="idhoja" <?php if (isset($reg[0]['idhoja'])) { ?> value="<?php echo encrypt($reg[0]['idhoja']); ?>" <?php } ?>>
                    <input type="hidden" name="codhoja" id="codhoja" <?php if (isset($reg[0]['codhoja'])) { ?> value="<?php echo encrypt($reg[0]['codhoja']); ?>" <?php } ?>/>
        ...
        <div class="row">
            <div class="col-md-4"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" class="form-control fecha_limite" type="text" name="fechacitologia" id="fechacitologia" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Citologia" autocomplete="off" <?php if (isset($reg[0]['fechacitologia'])) { ?> value="<?php echo $reg[0]['fechacitologia'] == '0000-00-00' ? "" : date("d-m-Y",strtotime($reg[0]['fechacitologia'])); ?>" <?php } ?> required="" aria-required="true">
                </div> 
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group has-feedback"> 
                    ...
                    <?php if (isset($reg[0]['embarazada'])) { ?>
                    <select style="color:#000;font-weight:bold;" name="embarazada" id="embarazada" class='form-control' onchange="Embarazada()" required="" aria-required="true">
                    <option value="">SELECCIONE</option>
            ...
            <div class="col-md-4">
                <div class="form-group has-feedback"> 
                    <label class="control-label">Fecha de Ultima Mestruación: </label> 
                    <input type="hidden" name="di" id="di" value="28">
                    <input type="hidden" name="sem" id="sem" value="14">
                    <input style="color:#000;font-weight:bold;" class="form-control fecha_limite" type="text" name="fechamestruacion" id="fechamestruacion" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Mestruación" autocomplete="off" <?php if (isset($reg[0]['fechamestruacion'])) { ?> value="<?php echo $reg[0]['fechamestruacion'] == '0000-00-00' ? "" : date("d-m-Y",strtotime($reg[0]['fechamestruacion'])); ?>" <?php } ?> <?php echo (isset($reg[0]['fechamestruacion']) && $reg[0]['embarazada'] == 'SI' ? '' : 'disabled="disabled"') ?> onchange="CalcularEmbarazo()" required="" aria-required="true">
                </div> 
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4"> 
                <div class="form-group has-feedback"> 
                    <label class="control-label">Fecha Probable de Parte: </label> 
                    <input type="hidden" name="fechaparto" id="fechaparto" <?php if (isset($reg[0]['fechaparto'])) { ?> value="<?php echo $reg[0]['fechaparto'] == '0000-00-00' ? "" : date("d-m-Y",strtotime($reg[0]['fechaparto'])); ?>" <?php } ?>>
                    <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="fechaparto2" id="fechaparto2" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha Probable de Parte" autocomplete="off" <?php if (isset($reg[0]['fechaparto'])) { ?> value="<?php echo $reg[0]['fechaparto'] == '0000-00-00' ? "" : date("d-m-Y",strtotime($reg[0]['fechaparto'])); ?>" <?php } ?> disabled="" required="" aria-required="true">
                </div> 
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group has-feedback"> 
                    ...
                    <input type="hidden" name="semanas" id="semanas" <?php if (isset($reg[0]['semanas'])) { ?> value="<?php echo $reg[0]['semanas']; ?>" <?php } ?>>
                    <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="semanas2" id="semanas2" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Semanas de Gestación" autocomplete="off" <?php if (isset($reg[0]['semanas'])) { ?> value="<?php echo $reg[0]['semanas']; ?>" <?php } ?> disabled="" required="" aria-required="true">
                </div> 
            </div>
        </div>


    <?php if(isset($_GET['numero']) && $reg[0]['codprocedimiento'] == 0) { ?>

        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Atención Actividad y/o Procedimiento</h5><hr>

        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback2">
                    <label class="control-label">Atención Actividad y/o Procedimiento: <span class="symbol required"></span></label> 
                    <textarea class="form-control" name="atenproced" id="atenproced" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Atención Actividad y/o Procedimiento" rows="4" required="" aria-required="true"><?php if (isset($reg[0]['atenproced'])) { echo $reg[0]['atenproced']; } ?></textarea> 
                </div> 
            </div>
        </div>

    <?php } else if(isset($_GET['numero']) && $reg[0]['codprocedimiento'] != 0) { ?>
    ...
    <?php } else { ?>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback2">
                    <label class="control-label">Atención Actividad y/o Procedimiento: <span class="symbol required"></span></label> 
                    <textarea class="form-control" name="atenproced" id="atenproced" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Atención Actividad y/o Procedimiento" rows="4" required="" aria-required="true"></textarea> 
                </div> 
            </div>
        </div>
    ...
    <?php } ?> 
        ...
        <div class="row">
            <div class="col-md-3"> 
                <div class="form-group has-feedback"> 
                    ...
                    <input class="form-control" type="text" name="ta" id="ta" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese TA" <?php if (isset($reg[0]['ta'])) { ?> value="<?php echo $reg[0]['ta']; ?>" <?php } ?> required="" aria-required="true">
                </div> 
            </div>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Identificación del Origen de la Enfermedad o Accidente</h5><hr>
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Dx Definitivo: <span class="symbol required"></span></label>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Remisión</h5><hr>

        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback">
                    <textarea class="form-control" name="remision" id="remision" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Remisión del Paciente" rows="2" required="" aria-required="true"><?php if (isset($reg[0]['remision'])) { echo $reg[0]['remision']; } ?></textarea>
                </div> 
            </div>
        </div>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Recetar Fórmulas Médicas</h5><hr>
        ...
        <div class="row">
            ...
            ?>
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Nombre de Dx para Fórmula Médica: </label>
                    ...
                    <textarea class="form-control" name="observacionformula[]<?php echo $cont; ?>" id="observacionformula<?php echo $cont; ?>" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Fórmula Médica" title="Ingrese Observación de Fórmula Médica" rows="2" required="" aria-required="true"><?php echo $observacionformula; ?></textarea>
                </div>
            ...
            <?php endfor; 
                ...
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="formula[]" id="formula" onKeyUp="this.value=this.value.toUpperCase(); autocompletar(this.name);" placeholder="Ingrese Nombre de Dx para tu Busqueda" title="Ingrese Dx Fórmula Médica">
                    <textarea class="form-control" name="observacionformula[]" id="observacionformula" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Dx Fórmula Médica" title="Ingrese Observación de Dx Fórmula Médica" rows="2"></textarea>
                </div>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Recetar Órdenes Médicas</h5><hr>
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Nombre de Dx para Orden Médica: </label>
            ...
            <?php endfor; 
                ...
                <div class="form-group has-feedback"> 
                    ...
                    <textarea class="form-control" name="observacionorden[]" id="observacionorden" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Dx Orden Médica" title="Ingrese Observación de Dx Orden Médica" rows="2"></textarea>
                </div>
