...
{
$reg = $tra->RegistrarCriocauterizaciones();
exit;
}
elseif(isset($_POST["proceso"]) and $_POST["proceso"]=="update")
{
$reg = $tra->ActualizarCriocauterizaciones();
exit;
} 
?>
<!DOCTYPE html>
...
<!--############################## MODAL BUSQUEDA DE CITAS EN CRIOCAUTERIZACIONES ######################################-->
<!-- Modal -->
...
<!--############################## MODAL BUSQUEDA DE CITAS EN CRIOCAUTERIZACIONES ######################################-->
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Gestión de Criocauterizaciones</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <form class="form-material" novalidate method="post" action="#" name="updatecriocauterizacion" id="updatecriocauterizacion" data-id="<?php echo $reg[0]["codcriocauterizacion"] ?>" enctype="multipart/form-data">
        
    <?php } else { ?>

    <form class="form-material" novalidate method="post" action="#" name="savecriocauterizacion" id="savecriocauterizacion" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" name="proceso" id="proceso" <?php if (isset($reg[0]['codcriocauterizacion'])) { ?> value="update" <?php } else { ?>  value="save" <?php } ?>/>
                    <input type="hidden" name="idcriocauterizacion" id="idcriocauterizacion" <?php if (isset($reg[0]['idcriocauterizacion'])) { ?> value="<?php echo encrypt($reg[0]['idcriocauterizacion']); ?>" <?php } ?>>
                    <input type="hidden" name="codcriocauterizacion" id="codcriocauterizacion" <?php if (isset($reg[0]['codcriocauterizacion'])) { ?> value="<?php echo encrypt($reg[0]['codcriocauterizacion']); ?>" <?php } ?>/>
                    ...
                    <?php if (isset($reg[0]['idcriocauterizacion'])) { ?>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback2">
                    ...
                    <textarea class="form-control" name="motivoconsulta" id="motivoconsulta" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Motivo de Consulta" rows="4" required="" aria-required="true"><?php if (isset($reg[0]['motivoconsulta'])) { echo $reg[0]['motivoconsulta']; } ?></textarea> 
                </div> 
            </div>
        </div>
