...
function encrypt($string, $key="@ClavePropiamenteEncriptadaWebMasterChirinos@") {
    $result = '';
...
function decrypt($string, $key="@ClavePropiamenteEncriptadaWebMasterChirinos@") {
...
return $calc_edad;
    ...
    echo "COCINERO(A)";
    } elseif ($muestra == "repartidor") {
    echo "REPARTIDOR";
    } 
    }

    function statuscita($muestra) {
