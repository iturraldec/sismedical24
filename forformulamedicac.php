...
<!--############################## MODAL BUSQUEDA DE CITAS EN FORMULAS MEDICAS ######################################-->
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Gestión de Recetas Médicas</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <?php } ?>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    <input type="hidden" name="formulario" id="formulario" value="<?php echo "forformulamedicac"; ?>"/>
        ...
        <hr><h5 class="card-subtitle text-dark alert-link"><i data-feather="file-text"></i> Recetas Médicas</h5><hr>
        ...
        <div class="row">
            ...
            ?>
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Nombre de Dx para Receta Médica: <span class="symbol required"></span></label>
            ...
            <?php endfor; 
                ...
                <div class="form-group has-feedback"> 
                    ...
                    <textarea class="form-control" name="observacionformula[]" id="observacionformula" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Dx Receta Médica" title="Ingrese Observación de Dx Receta Médica" rows="2" required="" aria-required="true"></textarea>
                </div>
