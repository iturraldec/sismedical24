...
$new = new Login();
$new = $new->ConfiguracionPorId();

$count = new Login();
$cita = $count->ContarCitas();
?>
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="panel">
                    ...
                    echo "<img src='fotos/logo_principal.png' alt='Logo Principal' class='dark-logo'>"; 
                        } else {
                    echo "<span class='navbar-brand-name'>SOFTWARE CLINICO</span>"; 
                        }
                    ?>
                </a>
            </div>
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                ...
                <li class="nav-item dropdown notification-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="notificationDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Citas Médicas">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg><?php echo $cita[0]["vencidas"] > 0 ? "<span style='background:#2196f3;' class='badge badge-success'></span>" : "<span style='background:#d51c0d;' class='badge badge-danger'></span>"; ?>
                    </a>
                        ...
                        <div class="notification-scroll">
                            ...
                            <div class="dropdown-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Atendidas</h6>
                                            <p class=""><span class="badge badge-info"><?php echo $cita[0]["atendidas"]; ?></span></p>
                                        </div>
                            ...
                            <div class="dropdown-item">
                                <div class="media">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text text-success"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Pendientes</h6>
                                            <p class=""><span class="badge badge-success"><?php echo $cita[0]["pendientes"]; ?></span></p>
                                        </div>
                            ...
                            <div class="dropdown-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Canceladas</h6>
                                            <p class=""><span class="badge badge-warning"><?php echo $cita[0]["canceladas"]; ?></span></p>
                                        </div>
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    ...
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Vencidas</h6>
                                            <p class=""><span class="badge badge-danger"><?php echo $cita[0]["vencidas"]; ?></span></p>
                                        </div>
                ...
                <li class="nav-item dropdown message-dropdown">
                    ...
                    <!--<a class="nav-link dropdown-toggle waves-effect waves-dark hour text-dark">--><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> <span id="spanreloj"></span>
                    </a>
                </li>
                        ...
                        <div class="media">
                            <?php if($_SESSION['acceso']=="medico"){
                                ...
                                if (isset($_SESSION['codigo'])) {
                                    ...
                                    echo "<img src='fotos/".$_SESSION['codigo'].".jpg?' width='40' height='40' class='img-fluid'>"; 
                                    } else {
                                    echo "<img src='fotos/medico.png' width='80' class='img-fluid'>"; 
                                    } } else {
                                    echo "<img src='fotos/medico.png' width='80' class='img-fluid'>"; 
                                    }
                                ...
                                if (isset($_SESSION['codigo'])) {
                                    ...
                                    echo "<img src='fotos/paciente.png' width='80' class='img-fluid'>"; 
                                    } } else {
                                    echo "<img src='fotos/paciente.png' width='80' class='img-fluid'>"; 
                                    }
                                ...
                                if (isset($_SESSION['codigo'])) {
                                    ...
                                    echo "<img src='fotos/avatar.png' width='80' class='img-fluid'>"; 
                                    } } else {
                                    echo "<img src='fotos/avatar.png' width='80' class='img-fluid'>"; 
                                    }
                            }
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <?php } ?>
                                <h6><small class="text-primary alert-link mb-0"><?php echo $_SESSION['nivel']; ?></small></h6>
                            </div>
                        </div>
