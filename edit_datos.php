...
{
$reg = $tra->ActualizarDatosMedicos();
exit;
} 
?>
<!DOCTYPE html>
...
<body onLoad="muestraReloj()" class="sidebar-noneoverflow">
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Actualizar Mis Datos</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <form class="form-material" novalidate method="post" action="#" name="updatedatos" id="updatedatos" data-id="<?php echo $_SESSION["codmedico"] ?>" enctype="multipart/form-data">
