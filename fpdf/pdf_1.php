...
############## VARIABLE PARA TAMAÑO DE LOGO HORIZONTAL ##############
...
############## VARIABLE PARA TAMAÑO DE LOGO VERTICAL ##############
...
function TablaListarDocumentos()
{
    ...
    $this->SetX(6);
    $this->Cell(55,5,"",0,0,'C');
    $this->CellFitSpace(90,5,"Nº TLF: ".utf8_decode($con[0]['tlfsucursal']),0,0,'C');
    $this->Cell(55,5,"",0,0,'C');
    ...
    $this->Cell(135,8,'DESCRIPCIÓN DE DOCUMENTO',1,1,'C', True);
...
function TablaListarSeguros()
{
    ...
    $this->Cell(90,8,'DIRECCIÓN DE SEGURO',1,1,'C', True);
...
function TablaListarSucursales()
{
    ...
    $this->Cell(30,8,'CANTÓN',1,0,'C', True);
    $this->Cell(30,8,'PROVINCIA',1,0,'C', True);
    $this->Cell(50,8,'DIRECCIÓN',1,0,'C', True);
    $this->Cell(40,8,'Nº DE TELÉFONO',1,0,'C', True);
...
function TablaListarPlantillasEcograficas()
{
    ...
    $this->Cell(220,8,'DESCRIPCIÓN DE PLANTILLA',1,1,'C', True);
...
function TablaListarMedicos()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE MÉDICOS',0,0,'C');
    ...
    $this->Cell(30,8,'CANTÓN',1,0,'C', True);
    $this->Cell(30,8,'PROVINCIA',1,0,'C', True);
    $this->Cell(60,8,'DIRECCIÓN',1,0,'C', True);
...
function TablaListarMedicosxSucursal()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE MÉDICOS POR SUCURSAL',0,0,'C');

    $this->Ln();
    $this->Cell(335,6,"Nº ".utf8_decode($reg[0]['documento2'])." SUCURSAL: ".utf8_decode($reg[0]["cuitsucursal"]),0,0,'L');
    $this->Ln();
...
function TablaListarHorarios()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE HORARIOS DE MÉDICOS',0,0,'C');
...
function TablaListarPacientes()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(30,8,'Nº HISTORIA',1,0,'C', True);
    $this->Cell(30,8,'Nº DOCUMENTO',1,0,'C', True);
...
function TablaListarCitasMedicas()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
...
function TablaListarCitasMedicasxFechas()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(75,8,'NOMBRE DE MÉDICO',1,0,'C', True);
...
function TablaListarCitasMedicasxMedicos()
{
    ...
    $this->Ln();
    $this->Cell(168,6,"Nº ".utf8_decode($reg[0]['documento2'])." SUCURSAL: ".utf8_decode($reg[0]["cuitsucursal"]),0,0,'L');
    $this->Cell(167,6,"Nº ".utf8_decode($documento = ($reg[0]['docummedico'] == '0' ? "DOCUMENTO" : $reg[0]['documento3'])).": ".utf8_decode($reg[0]["cedmedico"]),0,0,'L');
...
function TablaListarCitasMedicasxPacientes()
{
    ...
    $this->Ln();
    $this->Cell(168,6,"Nº ".utf8_decode($reg[0]['documento2'])." SUCURSAL: ".utf8_decode($reg[0]["cuitsucursal"]),0,0,'L');
    $this->Cell(167,6,"Nº ".utf8_decode($documento = ($reg[0]['documpaciente'] == '0' ? "DOCUMENTO" : $reg[0]['documento4'])).": ".utf8_decode($reg[0]["cedpaciente"]),0,0,'L');
    ...
    $this->Ln();
    $this->Cell(168,6,"ENCARGADO SUCURSAL: ".portales(utf8_decode($reg[0]["nomencargado"])),0,0,'L');
    $this->Cell(167,6,"Nº DE TELEFONO: ".portales(utf8_decode($reg[0]['tlfpaciente'] == '' ? "*********" : $reg[0]['tlfpaciente'])),0,0,'L');
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(40,8,'Nº DOCUMENTO',1,0,'C', True);
    $this->Cell(90,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(85,8,'MOTIVO DE CITA',1,0,'C', True);
    $this->Cell(50,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(30,8,'STATUS',1,0,'C', True);
    $this->Cell(30,8,'REGISTRADO',1,1,'C', True);
...
function TablaApertura()
  {
    ...
    $this->SetX(6);
    $this->Cell(55,5,"",0,0,'C');
    $this->CellFitSpace(90,5,"Nº TLF: ".utf8_decode($reg[0]['tlfsucursal']),0,0,'C');
    $this->Cell(55,5,"",0,0,'C');
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'APERTURA DE HISTORIA MÉDICA',0,0,'C');
    $this->Ln(4);
    ...
    $this->CellFitSpace(40,4,'Nº DE DOCUMENTO',1,0,'C');
    $this->Ln();
    ...
    $this->SetX(6);
    $this->SetFont('Courier','B',6.5);
    $this->CellFitSpace(80,4,'DIRECCIÓN DE RESIDENCIA HABITUAL(CALLE Y Nº MANZANA Y CASA)',1,0,'C');
    $this->CellFitSpace(20,4,'BARRIO',1,0,'C');
    $this->CellFitSpace(20,4,'PARROQUIA',1,0,'C');
    $this->CellFitSpace(20,4,'CANTÓN',1,0,'C');
    $this->CellFitSpace(20,4,'PROVINCIA',1,0,'C');
    $this->CellFitSpace(20,4,'ZONA(UR)',1,0,'C');
    $this->CellFitSpace(20,4,'Nº TELÉFONO',1,0,'C');
    $this->Ln();
    ...
    $this->CellFitSpace(40,4,'GRADO INSTRUCCIÓN',1,0,'C');
    $this->Ln();
    ...
    $this->CellFitSpace(15,5,edad($reg[0]['fnacpaciente'])." AÑOS",1,0,'L');
    ...
    $this->SetX(6);
    $this->SetFont('Courier','B',6.5);
    $this->CellFitSpace(30,4,'FECHA DE ADMISIÓN',1,0,'C');
    $this->CellFitSpace(40,4,'OCUPACIÓN',1,0,'C');
    ...
    $this->CellFitSpace(40,4,'DIRECCIÓN',1,0,'C');
    $this->CellFitSpace(40,4,'Nº TELÉFONO',1,0,'C');
    $this->Ln();
    ...
    $this->SetX(6);
    $this->SetFont('Courier','B',6.5);
    $this->CellFitSpace(40,4,'FECHA ULTIMA CITOLOGÍA',1,0,'C');
    $this->CellFitSpace(40,4,'EMBARAZADA',1,0,'C');
    $this->CellFitSpace(40,4,'FECHA ULTIMA MESTRUACIÓN',1,0,'C');
    $this->CellFitSpace(40,4,'SEMANAS DE GESTACIÓN',1,0,'C');
    ...
    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."ALÉRGICOS: ".portales(utf8_decode($reg[0]['antecedentealergico'])),1,'L');

    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."PATOLÓGICOS: ".portales(utf8_decode($reg[0]['antecedentepatologico'])),1,'L');

    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."QUIRÚRGICOS: ".portales(utf8_decode($reg[0]['antecedentequirurgico'])),1,'L');

    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."FARMACOLÓGICOS: ".portales(utf8_decode($reg[0]['antecedentefarmacologico'])),1,'L');

    if($reg[0]['sexopaciente'] == "FEMENINO"){

    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."GINECOLÓGICOS: ".portales(utf8_decode($reg[0]['antecedenteginecologico'])),1,'L');
    ...
    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."PLANIFICACIÓN FAMILIAR: ".portales(utf8_decode($reg[0]['planificacionfamiliar'])),1,'L');
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'IMPRESIÓN DIAGNÓSTICA',1,1,'C', True);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'IDENTIFICACIÓN DEL ORIGEN DE LA ENFERMEDAD',1,1,'C', True);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'DIAGNÓSTICO DEFINITIVO',1,1,'C', True);
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fechaapertura'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fechaapertura'])), 0, 0);
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'REMISIÓN',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'REMISIÓN',1,1,'C', True);
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fecharemision'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fecharemision'])), 0, 0);
    $this->Cell(100,4,portales(utf8_decode($reg[0]['nomespecialidad'])),0,1,'C');
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'FÓRMULA MÉDICA',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'FÓRMULA MÉDICA',1,1,'C', True);

    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."DX: ".portales(utf8_decode($formula))." \nFÓRMULA: ".utf8_decode(trim($observacionformula)),1,'J');
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fechaformula'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fechaformula'])), 0, 0);
    $this->Cell(100,4,portales(utf8_decode($reg[0]['nomespecialidad'])),0,1,'C');
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'ÓRDEN MÉDICA',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'ÓRDEN MÉDICA',1,1,'C', True);

    $this->SetX(6);
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->MultiCell(200,5,$this->SetFont('Courier','',11)."DX: ".portales(utf8_decode($orden))." \nFÓRMULA: ".utf8_decode(trim($observacionorden)),1,'J');
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fechaorden'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fechaorden'])), 0, 0);
    $this->Cell(100,4,portales(utf8_decode($reg[0]['nomespecialidad'])),0,1,'C');
...
function TablaListarAperturasxFechas()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
...
function TablaListarAperturasxPaciente()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(90,8,'ENFERMEDAD ACTUAL',1,0,'C', True);
    $this->Cell(90,8,'ANTECEDENTES',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaHojaEvolutiva()
  {
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'ATENCIÓN ACTIVIDAD Y/O PROCEDIMIENTO',1,1,'C', True);
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fechahoja'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fechahoja'])), 0, 0);
    $this->Cell(100,4,portales(utf8_decode($reg[0]['nomespecialidad'])),0,1,'C');
...
function TablaListarRemisiones()
{
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(110,8,'REMISIÓN',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarRemisionesxFechas()
{
    ...
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(150,8,'REMISIÓN',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarRemisionesxMedico()
{
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(180,8,'REMISIÓN',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarFormulasMedicas()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE FÓRMULAS MÉDICAS',0,0,'C');
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(110,8,'FÓRMULAS MÉDICAS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarFormulasMedicasxFechas()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE FÓRMULAS MÉDICAS POR FECHAS',0,0,'C');
    ...
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(150,8,'FÓRMULAS MÉDICAS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarFormulasMedicasxMedico()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE FÓRMULAS MÉDICAS POR MEDICO',0,0,'C');
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(180,8,'FÓRMULAS MÉDICAS',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarFormulasMedicasxPaciente()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE FÓRMULAS MÉDICAS POR PACIENTE',0,0,'C');
...
function TablaListarOrdenesMedicas()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE ÓRDENES MÉDICAS',0,0,'C');
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(110,8,'ÓRDENES MÉDICAS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarOrdenesMedicasxFechas()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE ÓRDENES MÉDICAS POR FECHAS',0,0,'C');
    ...
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(150,8,'ÓRDENES MÉDICAS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarOrdenesMedicasxMedico()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE ÓRDENES MÉDICAS POR MEDICO',0,0,'C');
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(180,8,'ÓRDENES MÉDICAS',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarOrdenesMedicasxPaciente()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE ÓRDENES MÉDICAS POR PACIENTE',0,0,'C');
...
function TablaFormulasTerapias()
  {
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'FÓRMULAS DE TERAPIAS',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'FÓRMULAS DE TERAPIAS',1,1,'C', True);
...
function TablaListarFormulasTerapias()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE FÓRMULAS DE TERAPIAS',0,0,'C');
...
function TablaListarFormulasTerapiasxPaciente()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(120,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(50,8,'RESPIRATORIAS',1,0,'C', True);
    $this->Cell(50,8,'FISICAS',1,0,'C', True);
    $this->Cell(50,8,'MICRONEBULIZACIONES',1,0,'C', True);
    $this->Cell(55,8,'FECHA | HORA',1,1,'C', True);
...
function TablaSolicitudExamenes()
  {
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'SOLICITUD EXÁMENES',0,0,'C');
    $this->Ln(4);

    $this->Ln();
    $this->SetFont('Courier','B',8);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(45,4,'NÚMERO DE IDENTIFICACIÓN: ',0,0,'L');
    $this->SetFont('Courier','',8); 
    $this->CellFitSpace(70,4,$reg[0]['cedpaciente'],0,0,'L');

    $this->SetFont('Courier','B',8); 
    $this->CellFitSpace(40,4,'TIPO DE IDENTIFICACIÓN: ',0,0,'L');
    $this->SetFont('Courier','',8); 
    ...
    $this->SetFont('Courier','',8); 
    $this->CellFitSpace(35,4,edad($reg[0]['fnacpaciente']).' AÑOS',0,0,'L');
    $this->Ln();
    ...
    $this->SetFont('Courier','B',8); 
    $this->CellFitSpace(40,4,'FECHA ELABORACIÓN: ',0,0,'L');
    $this->SetFont('Courier','',8); 
    ...
    $this->SetFont('Courier','B',9);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(50,5,'EXÁMENES DE SANGRE:',1,0,'C');
    ...
    $this->Cell(140,5,'PRIMERA ORINA DE LA MAÑANA NO DEBE TENER MAS DE 2 HORAS DE RECOLECCIÓN',1,0,'C');
    $this->Ln();
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fechasolicitud'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fechasolicitud'])), 0, 0);
    $this->Cell(100,4,portales(utf8_decode($reg[0]['nomespecialidad'])),0,1,'C');
...
function TablaListarSolicitudExamenes()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE SOLICITUD EXÁMENES',0,0,'C');
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(110,8,'DESCRIPCIÓN DE CIE',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarSolicitudExamenesxFechas()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE SOLICITUD EXÁMENES POR FECHAS',0,0,'C');
    ...
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(150,8,'DESCRIPCIÓN DE CIE',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarSolicitudExamenesxMedico()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE SOLICITUD EXÁMENES POR MEDICO',0,0,'C');
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(180,8,'DESCRIPCIÓN DE CIE',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarSolicitudExamenesxPaciente()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE SOLICITUD EXÁMENES POR PACIENTE',0,0,'C');
...
function TablaCriocauterizaciones()
  {
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'CRIOCAUTERIZACIÓN',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetX(6);
    $this->Cell(100, 4,'FECHA ELABORACIÓN: '.date("d-m-Y", strtotime($reg[0]['fechacriocauterizacion'])), 0, 0);
    $this->Cell(100,4,'DR. '.portales(utf8_decode($reg[0]['nommedico'])),0,1,'C');

    $this->SetX(6);
    $this->Cell(100, 4,'HORA ELABORACIÓN: '.date("H:i:s", strtotime($reg[0]['fechacriocauterizacion'])), 0, 0);
    $this->Cell(100,4,portales(utf8_decode($reg[0]['nomespecialidad'])),0,1,'C');
...
function TablaListarCriocauterizaciones()
{
    ...
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(60,8,'MOTIVO CONSULTA',1,0,'C', True);
    $this->Cell(50,8,'ATENCIÓN / ACTIVIDAD',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarCriocauterizacionesxFechas()
{
    ...
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(75,8,'MOTIVO CONSULTA',1,0,'C', True);
    $this->Cell(75,8,'ATENCIÓN / ACTIVIDAD',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarCriocauterizacionesxMedico()
{
    ...
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(90,8,'MOTIVO CONSULTA',1,0,'C', True);
    $this->Cell(90,8,'ATENCIÓN / ACTIVIDAD',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaColposcopia()
  {
    ...
    $this->CellFitSpace(94,5,'- Zona de Transformación Típica:',1,0,'L');
    ...
    $this->CellFitSpace(94,5,'- Zona de Transformación Atípica:',1,0,'L');
    ...
    $this->CellFitSpace(94,5,'- Vasos atípicos(hormquilla, sacacorchos, astenosis, dilataciones):',1,0,'L');
    ...
    $this->SetFont('Courier','',8);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(74,5,'5. IMPRESIÓN DIAGNOSTICA:',1,0,'L');
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'OBSERVACIÓN',1,0,'C', True);
    $this->Ln();
    ...
    $this->SetFont('Courier','',8);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(100,5,'1. LA UNIÓN ESCAMOCOLUMNAR ES VISIBLE? '.$reg[0]['tunion'],1,0,'L');
    $this->Cell(100,5,'2. LA LESIÓN ES COMPLETAMENTE VISIBLE? '.$reg[0]['tlesion'],1,0,'L');
    $this->Ln();
...
function TablaListarColposcopias()
{
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(60,8,'IMPRESIÓN DIAGNOSTICA',1,0,'C', True);
...
function TablaListarColposcopiasxFechas()
{
    ...
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(75,8,'IMPRESIÓN DIAGNOSTICA',1,0,'C', True);
...
function TablaListarColposcopiasxMedico()
{
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(90,8,'IMPRESIÓN DIAGNOSTICA',1,0,'C', True);
...
function TablaEcografia()
  {
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'ECOGRAFÍA',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'PROCEDIMIENTO ECOGRÁFICO',1,0,'C', True);
    $this->Ln();
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'DESCRIPCIÓN ECOGRÁFICA',1,0,'C', True);
    $this->Ln();
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'IMÁGENES ECOGRAFICAS',0,0,'C');
    $this->Ln(10);
...
function TablaListarEcografias()
{
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(110,8,'PROCEDIMIENTO ECOGRÁFICO',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarEcografiasxFechas()
{
    ...
    $this->Cell(70,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(70,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(150,8,'PROCEDIMIENTO ECOGRÁFICO',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarEcografiasxMedico()
{
    ...
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(100,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(180,8,'PROCEDIMIENTO ECOGRÁFICO',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
############################### FUNCION PARA MOSTRAR EXÁMEN DE LABORATORIO ################################# 
function TablaLaboratorio()
  {
    ...
    $this->SetFont('Courier','B',9);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(95,4,'HEMATOLOGÍA' ,1,0,'C');
    $this->Cell(101,4,'QUIMÍCA SANGUÍNEA' ,1,0,'C');
    $this->Ln();
    
    $this->SetFont('Courier','',7);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(33,4,'EXÁMEN' ,1,0,'C');
    ...
    $this->Cell(16,4,'%',1,0,'R');
    $this->Cell(33,4,'ACIDO ÚRICO' ,1,0,'L');
    ...
    $this->SetFont('Courier','B',9);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(95,4,'UROANÁLISIS' ,1,0,'C');
    $this->Cell(101,4,'INMUNOLOGÍA' ,1,0,'C');
    $this->Ln();
    
    
    $this->SetFont('Courier','',7);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(45,4,'EXÁMEN QUIMICO',1,0,'C');
    $this->Cell(40,4,'EXÁMEN MICROSCOPICO' ,1,0,'C');
    ...
    $this->Cell(101,4,'COPROPARASITOLOGÍA',1,0,'C');
    $this->Ln();
    ...
    $this->SetFont('Courier','',7); 
    $this->Cell(43,4,'EXÁMEN FRESCO',1,0,'C');
    ...
    $this->SetFont('Courier','B',7);
    $this->Cell(101,4,'MICROBIOLOGÍA',1,0,'C');
    $this->Ln();
    ...
    $this->MultiCell(196,4,$this->SetFont('Courier','B',8)."OBSERVACIONES HEMATOLOGÍA: ".portales(utf8_decode($reg[0]['observacioneshematologia'])),0,'L');
    $this->Ln();
    }

    if($reg[0]['observacionesquimica'] != ""){
    $this->MultiCell(196,4,$this->SetFont('Courier','B',8)."OBSERVACIONES QUÍMICA: ".portales(utf8_decode($reg[0]['observacionesquimica'])),0,'L');
    $this->Ln();
    }
    
    if($reg[0]['observacionesuroanalisis'] != ""){
    $this->MultiCell(196,4,$this->SetFont('Courier','B',8)."OBSERVACIONES UROANÁLISIS: ".portales(utf8_decode($reg[0]['observacionesuroanalisis'])),0,'L');
    $this->Ln();
    }
...
function TablaListarLaboratorios()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE EXÁMENES DE LABORATORIOS',0,0,'C');
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(55,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(55,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(45,8,'HEMATOLOGIA',1,0,'C', True);
    $this->Cell(45,8,'QUÍMICA SANGUINEA',1,0,'C', True);
    $this->Cell(40,8,'UROANÁLISIS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,0,'C', True);
    $this->Cell(50,8,'SUCURSAL',1,1,'C', True);
...
function TablaListarLaboratoriosxFechas()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE EXÁMENES DE LABORATORIOS POR FECHAS',0,0,'C');
    ...
    $this->Cell(60,8,'QUÍMICA SANGUINEA',1,0,'C', True);
    $this->Cell(60,8,'UROANÁLISIS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarLaboratoriosxMedico()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE EXÁMENES DE LABORATORIOS POR MEDICO',0,0,'C');
    ...
    $this->Cell(75,8,'QUÍMICA SANGUINEA',1,0,'C', True);
    $this->Cell(75,8,'UROANÁLISIS',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarLaboratoriosxPaciente()
{
    ...
    $this->SetFont('Courier','B',14);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->Cell(335,10,'LISTADO DE EXÁMENES DE LABORATORIOS POR PACIENTE',0,0,'C');
...
function TablaRadiologia()
  {
    ...
    $this->SetFont('Courier','B',11);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(60,5,'Nº DE IDENTIFICACIÓN: ',0,0,'L');
    ...
    $this->SetFont('Courier','',12);  
    $this->CellFitSpace(140,5,edad($reg[0]['fnacpaciente']).' AÑOS',0,0,'L');
    ...
    $this->SetFont('Courier','B',11);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(60,5,'FECHA DE ELABORACIÓN: ',0,0,'L');
    $this->SetFont('Courier','',12);  
...
function TablaListarRadiologiasxFechas()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(80,8,'NOMBRE DE MÉDICO',1,0,'C', True);
...
function TablaTerapia()
  {
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'HOJA EVOLUCIÓN DE TERAPIAS',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es blanco)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL
    $this->Cell(200,6,'DIAGNÓSTICO',1,1,'C', True);
    ...
    $this->SetFont('Courier','B',9);    
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(10,4,'Nº ',1,0,'C');
...
function TablaListarTerapias()
{
    ...
    $this->Cell(65,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(65,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(80,8,'DIAGNÓSTICO',1,0,'C', True);
...
function TablaListarTerapiasxFechas()
{
    ...
    $this->Cell(75,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(75,8,'NOMBRE DE PACIENTE',1,0,'C', True);
    $this->Cell(110,8,'DIAGNÓSTICO',1,0,'C', True);
    $this->Cell(30,8,'CICLO',1,0,'C', True);
    $this->Cell(35,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarTerapiasxMedico()
{
    ...
    $this->Cell(140,8,'DIAGNÓSTICO',1,0,'C', True);
    $this->Cell(30,8,'CICLO',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaListarTerapiasxPaciente()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(110,8,'NOMBRE DE MÉDICO',1,0,'C', True);
    $this->Cell(140,8,'DIAGNÓSTICO',1,0,'C', True);
    $this->Cell(30,8,'CICLO',1,0,'C', True);
    $this->Cell(45,8,'FECHA | HORA',1,1,'C', True);
...
function TablaOdontologia()
  {
    ...
    $this->SetFont('Courier','B',16);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'FICHA ODONTOLOGÍCA',0,0,'C');
    $this->Ln(4);
    ...
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(11,5,'1-4 AÑOS',1,0,'C');
    $this->SetFont('Courier','B',8);
    $this->Cell(5,5,$variable = ($reg[0]['1_4'] == 'X' ? "X" : ""),1,0,'C');
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(28,5,'5-9 AÑOS PROGRAMADO',1,0,'C');
    $this->SetFont('Courier','B',8);
    $this->Cell(5,5,$variable = ($reg[0]['5_9'] == 'X' ? "X" : ""),1,0,'C');
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(28,5,'5-14 AÑOS NO PROGRAMADO',1,0,'C');
    $this->SetFont('Courier','B',8);
    $this->Cell(5,5,$variable = ($reg[0]['5_14'] == 'X' ? "X" : ""),1,0,'C');
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(28,5,'10-14 AÑOS PROGRAMADO',1,0,'C');
    $this->SetFont('Courier','B',8);
    $this->Cell(5,5,$variable = ($reg[0]['10_14'] == 'X' ? "X" : ""),1,0,'C');
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(15,5,'15-19 AÑOS',1,0,'C');
    $this->SetFont('Courier','B',8);
    $this->Cell(5,5,$variable = ($reg[0]['15_19'] == 'X' ? "X" : ""),1,0,'C');
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(20,5,'MAYOR DE 20 AÑOS',1,0,'C');
    $this->SetFont('Courier','B',8);
    ...
    $this->SetFont('Courier','B',6);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(35,4,'1. ALERGIA ANTIBIÓTICO',1,0,'C');
    $this->SetFont('Courier','B',8);
    ...
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(35,4,'8. HIPERTENSIÓN',1,0,'C');
    $this->SetFont('Courier','B',8);
    ...
    $this->SetFont('Courier','B',6);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(40,5,'PRESIÓN ARTERIAL',1,0,'C');
    ...
    $this->SetFont('Courier','B',12);  
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->CellFitSpace(200,5,'5. EXAMEN DEL SISTEMA ESTOMATOGNÁTICO',1,1,'L', True);
    ...
    $this->SetFont('Courier','B',6);
    $this->CellFitSpace(35,4,'9. GLÁNDULAS SALIVALES',1,0,'C');
    $this->SetFont('Courier','B',8);
    ...
    $this->Cell(2,5,'',0,0,'L');
    $this->CellFitSpace(58,5,'8. ÍNDICES CPO-ceo',1,1,'L', True);
    ...
    $this->CellFitSpace(20,5,'MAL OCLUSIÓN',1,0,'C');
    ...
    $this->CellFitSpace(15,5,'CÁLCULO',1,0,'C');
    ...
    $this->CellFitSpace(200,5,'9. PLANES DE DIAGNÓSTICO, TERAPÉUTICO Y EDUCACIONAL',1,1,'L', True);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es VERDE)
    $this->CellFitSpace(200,5,'10. DIAGNÓSTICO',1,1,'L', True);
    ...
    $this->Cell(15,5,"",1,0,'C');
    $this->CellFitSpace(15,5,'Nº DE HOJA',1,0,'C', True);
    $this->SetFont('Courier','B',6.5);
    ...
    $this->SetTextColor(3,3,3);  // Establece el color del texto (en este caso es negro)
    $this->SetFillColor(204,255,204); // establece el color del fondo de la celda (en este caso es VERDE)
    $this->CellFitSpace(26,5,'SESIÓN : FECHA',1,0,'C', True);
    ...
    $this->CellFitSpace(30,5,'CÓDIGO Y FIRMA',1,1,'C', True);
...
function TablaConsentimientoInformado()
  {
    ...
    $this->SetFont('Courier','',9); 
    $this->WriteFlowingBlock('PARA SATISFACCIÓN DE LOS ');
    $this->SetFont('Courier', 'B', 9);
    $this->WriteFlowingBlock('DERECHOS DEL PACIENTE, ');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('COMO INSTRUMENTO FAVORECEDOR DEL CORRECTO USO DE LOS PROCEDIMIENTOS TERAPÉUTICOS Y DIAGNÓSTICOS' );
    $this->finishFlowingBlock();
    $this->Ln(2);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier','',9); 
    $this->WriteFlowingBlock('YO D/Dª ');
    $this->SetFont('Courier', 'B', 9);
    ...
    $this->SetFont('Courier', 'B', 9);
    $this->WriteFlowingBlock($reg[0]['documento']." Nº ".$reg[0]['cedpaciente']);
    $this->SetFont('Courier','',9); 
    ...
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock(' ME HA EXPLICADO, EN TÉRMINOS ASEQUIBLES, LA NATURALEZA EXACTA DE LA INTERVENCIÓN O PROCEDIMIENTO QUE SE ME VA A REALIZAR Y SU NECESIDAD. HE TENIDO LA OPORTUNIDAD DE DISCUTIR CON EL FACULTATIVO CÓMO SE VA A EFECTUAR, SU PROPÓSITO, LAS ALTERNATIVAS RAZONABLES, LAS POSIBLES CONSECUENCIAS DE NO HACER ESTE TRATAMIENTO Y TODOS LOS RIESGOS Y POSIBLES COMPLICACIONES QUE DE ÉL PUEDAN DERIVARSE. ');
    $this->finishFlowingBlock();
    $this->Ln(2);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('COMPRENDO TAMBIÉN QUE UN RESULTADO INDESEABLE NO NECESARIAMENTE IMPLICA UN ERROR EN ESE JUICIO, POR LO QUE BUSCANDO LOS MEJORES RESULTADOS CONFÍO EN QUE EL CONOCIMIENTO Y LAS DECISIONES DEL PROFESIONAL DURANTE EL PROCEDIMIENTO O INTERVENCIÓN ESTARÁN BASADOS SOBRE LOS HECHOS HASTA ENTONCES CONOCIDOS, BUSCANDO SIEMPRE MI MAYOR BENEFICIO.');
    $this->finishFlowingBlock();
    $this->Ln(2);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('ME HA EXPLICADO QUE EL TRATAMIENTO QUE SE VA A HACER SE EFECTUARÁ BAJO ANESTESIA LOCAL, O GENERAL EN LOS CASOS QUE REQUIEREN HOSPITALIZACIÓN. SU FINALIDAD ES BLOQUEAR, DE FORMA REVERSIBLE, LA TRANSMISIÓN DE LOS IMPULSOS NERVIOSOS, PARA PODER REALIZAR LA INTERVENCIÓN SIN DOLOR.');
    $this->finishFlowingBlock();
    $this->Ln(2);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('SI BIEN A PARTIR DE MIS ANTECEDENTES PERSONALES NO SE DEDUCEN POSIBLES ALERGIAS O HIPERSENSIBILIDAD A LOS COMPONENTES DE LA SOLUCIÓN ANESTÉSICA, ELLO NO EXCLUYE LA POSIBILIDAD DE QUE, A PESAR DE SER MUY IMPROBABLE, PUEDAN PRESENTARSE MANIFESTACIONES ALÉRGICAS DEL TIPO URTICARIA, DERMATITIS DE CONTACTO, ASMA, EDEMA ANGIONEURÓTICO, Y EN CASOS EXTREMOS SHOCK ANAFILÁCTICO, QUE PUEDEN REQUERIR TRATAMIENTO URGENTE.');
    $this->finishFlowingBlock();
    $this->Ln(2);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('LAS SUSTANCIAS QUE CONTIENE LA SOLUCIÓN ANESTÉSICA PUEDEN ORIGINAR LEVES ALTERACIONES DEL PULSO Y DE LA TENSIÓN ARTERIAL. SE ME HA INFORMADO QUE, AÚN EN EL CASO DE QUE NO SE DEDUZCA NINGÚN TIPO DE PATOLOGÍA CARDIOVASCULAR DE MIS ANTECEDENTES, LA PRESENCIA DE ADRENALINA PUEDE FAVORECER, AUNQUE DE FORMA MUY INUSUAL, LA APARICIÓN DE ARRITMIAS LEVES.');
    $this->finishFlowingBlock();
    $this->Ln(2);
    ...
    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier','',9);
    $this->WriteFlowingBlock('• QUE ESTAS COMPLICACIONES GENERALES PUEDEN REQUERIR TRATAMIENTOS MÉDICO-QUIRÚRGICOS ADICIONALES Y QUE, RARAMENTE, ALGUNAS PUEDEN DEJAR SECUELAS DEFINITIVAS.');
    $this->finishFlowingBlock();

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier','',9);
    $this->WriteFlowingBlock('• LA BIOPSIA CONSISTE EN LA TOMA DE UNA MUESTRA REPRESENTATIVA DE LA LESIÓN. ESTE PROCEDIMIENTO ANALIZADO POR EL PATÓLOGO, NOS DA EL DIAGNÓSTICO DEFINITIVO DE LA LESIÓN, LO QUE DARÁ PASO AL COMIENZO DEL TRATAMIENTO CONCRETO DE LA MISMA. LAS COMPLICACIONES POTENCIALES DE ESTE TRATAMIENTO QUIRÚRGICO, SON, APARTE DE LAS MENCIONADAS PREVIAMENTE:');
    $this->finishFlowingBlock();

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier','',9);
    $this->WriteFlowingBlock('- NECESIDAD DE REPETIR LA BIOPSIA, SI EL PATÓLOGO NECESITARA OTRA MUESTRA PARA UN ANÁLISIS HISTOLÓGICO MÁS DETALLADO');
    $this->finishFlowingBlock();

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier','',9);
    $this->WriteFlowingBlock('- INFECCIÓN POSTQUIRÚRGICA DE LA ZONA BIOPSIADA.');
    $this->finishFlowingBlock();

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier','',9);
    $this->WriteFlowingBlock('- HEMORRAGIA DURANTE LAS PRIMERAS HORAS POSTINTERVENCIÓN.');
    $this->finishFlowingBlock();
    ...
    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('CONSIENTO EN QUE SE TOMEN FOTOGRAFÍAS O REGISTROS EN OTROS TIPOS DE SOPORTE AUDIOVISUAL, ANTES, DURANTE Y DESPUÉS DE LA INTERVENCIÓN QUIRÚRGICA, PARA FACILITAR EL AVANCE DEL CONOCIMIENTO CIENTÍFICO Y LA DOCENCIA. EN TODOS LOS CASOS SERÁ RESGUARDADA LA IDENTIDAD DEL/DE LA PACIENTE.');
    $this->finishFlowingBlock();
    $this->Ln(2);
    ...
    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('SI SURGIERA CUALQUIER SITUACIÓN INESPERADA DURANTE LA INTERVENCIÓN, AUTORIZO A MI ESPECIALISTA A REALIZAR CUALQUIER PROCEDIMIENTO O MANIOBRA QUE, EN SU JUICIO CLÍNICO, ESTIME OPORTUNA PARA MI MEJOR TRATAMIENTO.');
    $this->finishFlowingBlock();
    $this->Ln(2);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('TAMBIÉN COMPRENDO, QUE EN CUALQUIER MOMENTO Y SIN NECESIDAD DE DAR NINGUNA EXPLICACIÓN, PUEDO REVOCAR EL CONSENTIMIENTO QUE AHORA PRESTO.');
    $this->finishFlowingBlock();
    $this->Ln(4);

    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('POR ELLO, ME CONSIDERO EN CONDICIONES DE PONDERAR DEBIDAMENTE TANTO LOS RIESGOS COMO LA UTILIDAD Y BENEFICIO QUE PUEDO OBTENER DEL TRATAMIENTO; ASÍ PUES, MANIFIESTO QUE ESTOY SATISFECHO/A CON LA INFORMACIÓN RECIBIDA Y POR ELLO,');
    ...
    $this->newFlowingBlock(190, 4, 0, 'J');
    $this->SetFont('Courier', '', 9);
    $this->WriteFlowingBlock('Y PARA QUE ASÍ CONSTE, FIRMO EL PRESENTE ORIGINAL DESPUÉS DE LEÍDO.');
    $this->finishFlowingBlock();
    $this->Ln(2);
    ...
    $this->WriteFlowingBlock(' DIAS DEL AÑO ');
    $this->SetFont('Courier', 'B', 9);
    ...
    $this->CellFitSpace(80,4,'FIRMA DEL MÉDICO/'.portales(utf8_decode($reg[0]['nomespecialidad'])),0,0,'L');
    $this->Ln();
...
function TablaListarConsentimientos()
{
    ...
    $this->SetFillColor(30, 116, 172); // establece el color del fondo de la celda (en este caso es AZUL)
    $this->Cell(10,8,'Nº',1,0,'C', True);
    $this->Cell(60,8,'NOMBRE DE MÉDICO',1,0,'C', True);
