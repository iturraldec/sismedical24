...
function __construct($orientation='P', $unit='mm', $size='A4')
{
	...
	$this->StdPageSizes = array(
		...
		'mitad'=>array(311,396), 
		'ticket'=>array(211,550), 
		'ticketcredito'=>array(211,520), 
		'ticket3'=>array(211,650), 
		'cierre'=>array(211,500), 
		'movimiento'=>array(211,320)
	);
...
function MultiAlignCell($w,$h,$text,$border=0,$ln=0,$align='L',$fill=false)
{
	...
	$this->MultiCell($w,4,$text,$border,$align,$fill);
...
function MultiAlignCell2($w,$h,$text,$border=0,$ln=0,$align='L',$fill=false)
{
    // Store reset values for (x,y) positions
	$x = $this->GetX() + $w;
	$y = $this->GetY();
    ...
    // Make a call to FPDF's MultiCell
	$this->MultiCell($w,3,$text,$border,$align,$fill);
