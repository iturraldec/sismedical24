                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Ginecologías por Fechas</h5>
                                    </div>                 
                                </div>
                            </div>

    <div class="widget-content widget-content-area">                                
        <form class="form form-material" method="post" action="#" name="ginecologiasxfechas" id="ginecologiasxfechas">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        <div class="form-check form-check-inline">
                            <div class="custom-control custom-checkbox">
                                <input type="radio" class="custom-control-input" name="busqueda" id="optradio3" value="<?php echo encrypt("b"); ?>">
                                <label class="custom-control-label text-dark alert-link" for="optradio3">REMISIONES</label>
                            </div>
                        </div> 
                    </div>
        ...
        <button type="button" onClick="BuscarGinecologiasxFechas()" class="btn btn-primary"><i data-feather="search"></i> Realizar Búsqueda</button>
                                    </div>
            ...
            <div id="muestraginecologiasxfechas"></div>
