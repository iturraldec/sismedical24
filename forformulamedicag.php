...
<!--############################## MODAL BUSQUEDA DE CITAS EN FORMULAS MEDICAS ######################################-->
<!-- Modal -->
...
<!--############################## MODAL BUSQUEDA DE CITAS EN FORMULAS MEDICAS ######################################-->
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Gestión de Fórmulas Médicas</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <form class="form-material" novalidate method="post" action="#" name="updateformulamedica" id="updateformulamedica" data-id="<?php echo $reg[0]["codformulam"] ?>" enctype="multipart/form-data">
        
    <?php } else { ?>

    <form class="form-material" novalidate method="post" action="#" name="saveformulamedica" id="saveformulamedica" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    <input type="hidden" name="formulario" id="formulario" value="<?php echo "forformulamedicag"; ?>"/>
                    <input type="hidden" name="modulo" id="modulo" value="<?php echo "2"; ?>"/>
                    <input type="hidden" name="proceso" id="proceso" <?php if (isset($reg[0]['codformulam'])) { ?> value="update" <?php } else { ?>  value="save" <?php } ?>/>
                    <input type="hidden" name="idformulam" id="idformulam" <?php if (isset($reg[0]['idformulam'])) { ?> value="<?php echo encrypt($reg[0]['idformulam']); ?>" <?php } ?>>
                    <input type="hidden" name="codformulam" id="codformulam" <?php if (isset($reg[0]['codformulam'])) { ?> value="<?php echo encrypt($reg[0]['codformulam']); ?>" <?php } ?>/>
        ...
        <div class="row">
            ...
            <?php endfor; 
                ...
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="formula[]" id="formula" onKeyUp="this.value=this.value.toUpperCase(); autocompletar(this.name);" placeholder="Ingrese Nombre de Dx para tu Busqueda" title="Ingrese Dx Fórmula Médica" required="" aria-required="true">
                    <textarea class="form-control" name="observacionformula[]" id="observacionformula" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Dx Fórmula Médica" title="Ingrese Observación de Dx Fórmula Médica" rows="2" required="" aria-required="true"></textarea>
                </div>
