...
<!--############################## MODAL BUSQUEDA DE CITAS EN ORDENES MEDICAS ######################################-->
<!-- Modal -->
...
<!--############################## MODAL BUSQUEDA DE CITAS EN ORDENES MEDICAS ######################################-->
                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="card-subtitle text-dark alert-link"><i data-feather="align-justify"></i> Gestión de Ordenes Médicas</h5>
                                    </div>                 
                                </div>
                            </div>
    ...
    <form class="form-material" novalidate method="post" action="#" name="updateordenmedica" id="updateordenmedica" data-id="<?php echo $reg[0]["codorden"] ?>" enctype="multipart/form-data">
        
    <?php } else { ?>

    <form class="form-material" novalidate method="post" action="#" name="saveordenmedica" id="saveordenmedica" enctype="multipart/form-data">
    ...
    <?php } ?>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    <input type="hidden" name="formulario" id="formulario" value="<?php echo "forordenmedicag"; ?>"/>
                    <input type="hidden" name="modulo" id="modulo" value="<?php echo "2"; ?>"/>
                    <input type="hidden" name="proceso" id="proceso" <?php if (isset($reg[0]['codorden'])) { ?> value="update" <?php } else { ?>  value="save" <?php } ?>/>
                    <input type="hidden" name="idorden" id="idorden" <?php if (isset($reg[0]['idorden'])) { ?> value="<?php echo encrypt($reg[0]['idorden']); ?>" <?php } ?>>
                    <input type="hidden" name="codorden" id="codorden" <?php if (isset($reg[0]['codorden'])) { ?> value="<?php echo encrypt($reg[0]['codorden']); ?>" <?php } ?>/>
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback">
                    <textarea class="form-control" name="remision" id="remision" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Remisión del Paciente" rows="4" required="" aria-required="true"><?php if (isset($reg[0]['remision'])) { echo $reg[0]['remision']; } ?></textarea>
                </div> 
            </div>
        </div>
        ...
        <div class="row">
            ...
            ?>
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Nombre de Dx para Fórmula Médica: <span class="symbol required"></span></label>
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="form-group has-feedback"> 
                    <label class="control-label alert-link">Nombre de Dx para Orden Médica: <span class="symbol required"></span></label>
            ...
            <?php endfor; 
                ...
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" class="form-control" type="text" name="ordenes[]" id="ordenes" onKeyUp="this.value=this.value.toUpperCase(); autocompletar(this.name);" placeholder="Ingrese Nombre de Dx para tu Busqueda" title="Ingrese Dx Orden Médica" required="" aria-required="true">
                    <textarea class="form-control" name="observacionorden[]" id="observacionorden" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Observación de Dx Orden Médica" title="Ingrese Observación de Dx Orden Médica" rows="2" required="" aria-required="true"></textarea>
                </div>
