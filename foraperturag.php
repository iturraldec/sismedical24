        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="input-group">
                    <input type="hidden" name="formulario" id="formulario" value="<?php echo "foraperturag"; ?>"/>
        ...
        <div class="row">
            ...
            <div class="col-md-4"> 
                <div class="form-group has-feedback2">
                    ...
                    <textarea class="form-control" name="antecedentefarmacologico" id="antecedentefarmacologico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Farmacológicos" rows="2" required="" aria-required="true"><?php if (isset($reg[0]['antecedentefarmacologico'])) { echo $reg[0]['antecedentefarmacologico']; } ?></textarea> 
                </div> 
            </div>
        </div>
...
<a class="btn btn-danger rounded-circle" onClick="DeleteDxPresuntivo()" title="Quitar"><i data-feather="x-circle"></i></a>
            ...
            ?>
                <div class="form-group has-feedback"> 
                    ...
                    <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="presuntivo[]<?php echo $cont; ?>" id="presuntivo<?php echo $cont; ?>" onKeyUp="this.value=this.value.toUpperCase(); autocompletar(this.name);" value="<?php echo $presuntivo; ?>" placeholder="Ingrese Nombre de Dx para tu Busqueda" title="Ingrese Dx Presuntivo" required="" aria-required="true">
